...
contract JntrX is ERC20,JntrX_Utils{


    string public constant name = "Jointer/x Token";
    string public constant symbol = "JNTR/x";
    ...
    constructor(uint initialSupply,
                ...
                address _whiteList) public JntrX_Utils(_secondaryOwner,_systemAddress){
        uint256 _totalSupply = initialSupply * 10 ** uint256(decimals);
    ...
    function balanceOf(address _who) public view returns (uint) {
     ...
     function transfer(address _to, uint256 _value) public returns (bool ok) {
        ...
        if(_to == jntrAddress || _to == jntrEAddress){
    ...
    function swapForToken(uint256 _tokenPrice,address _to,uint256 _value) public returns (bool){
        ...
        require(msg.sender == jntrEAddress || msg.sender == jntrAddress ,"sender is not valid");
