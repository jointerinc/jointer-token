...
const whiteListCode = "0x57484954455f4c49535400000000000000000000000000000000000000000000";
const mainTokenCode = "0x4d41494e5f544f4b454e00000000000000000000000000000000000000000000";
const currencyCode = "0x43555252454e4359000000000000000000000000000000000000000000000000";
...
module.exports = async function (deployer) {
    ...
    txHash = await whiteListInstance.addNewWallet(ownerWallet, 8195, 10, {
    ...
    await deployer.deploy(
      ...
      tokenVaultInstance = await TokenVault.deployed();
