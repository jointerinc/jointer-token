...
module.exports = async function (deployer) {
    ...
    // txHash1 = await converterInstancAe.addConnector(mainToken, "500000", false, {
    //     from: ownerWallet
    // });
    ...
    // console.log("txHash8",txHash8)
    // console.log("txHash9",txHash9)
    // console.log("txHash10",txHash10)
    // console.log("txHash11",txHash11)
    // console.log("txHash12",txHash12)
}